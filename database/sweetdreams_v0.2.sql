...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-01-2022 a las 04:31:33
...
INSERT INTO `products` (`prod_id`, `name`, `price`, `discount`, `prod_categ_id`, `flavor_id`, `size_id`, `image`) VALUES
(1, 'Sofía', 2400, 25, 1, 1, 3, '...'),
(2, 'Lucía', 2500, 1, 1, 2, 2, '...'),
(3, 'Emma', 2200, 13, 1, 3, 1, ''),
(4, 'Chocolate', 1400, 31, 2, 4, 1, '...'),
(5, 'Red Velvet', 2500, 42, 2, 5, 1, ''),
(6, 'Caramelo', 1200, 3, 2, 6, 1, ''),
(7, 'Manzanita de hojaldre', 600, 18, 3, 7, 1, '...'),
(8, 'Palmerita', 500, 31, 3, 8, 1, ''),
(9, 'Caracola', 300, 39, 3, 9, 1, '');
